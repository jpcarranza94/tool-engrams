"""English stopword set — vendored from NLTK 3.9 (nltk.corpus.stopwords).

We vendor this instead of depending on NLTK because:
  - NLTK is a heavy dependency for a 200-word list
  - NLTK requires a separate `nltk.download('stopwords')` step
  - This list is stable and well-curated by computational linguists

Source: https://github.com/nltk/nltk_data/blob/gh-pages/packages/corpora/stopwords.zip
License: Apache 2.0 (same as NLTK)
"""
